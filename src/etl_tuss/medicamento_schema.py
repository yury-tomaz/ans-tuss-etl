"""Normalização da extensão de medicamentos (Tab 20) para o modelo canônico.

Responsabilidade única: mapear os rótulos extras da Tab 20 para campos
...
EXTENSION_COLUMNS: tuple[str, ...] = tuple(field.name for field in fields(MedicamentoExtensao))
...
def normalize_medicamento(sheet: pl.DataFrame) -> pl.DataFrame:
    """Mapeia as colunas extras da Tab 20 para a extensão canônica de medicamentos."""
